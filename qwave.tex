...
%	
	...
	P_R^2	~~=~~	P_R\,,
\end{align}
	which we judiciously have named them left- and right- projectors.
...
\end{equation}
	...
	For this reason we have not given names to these supspaces, other than ``spin-up'' and
	``spin-down'' spaces.

	The easiest solution to \eqref{PRL} is using the orthogonality of the projectors:
\begin{align}
	&
	P_R\, P_L	~~=~~	0\,,
	&
...
\end{align}
	...
	This fact by puts them into the opposite chirality spaces.
...
\end{equation}
	...
	arbitrary quaterions by projectors $ P_L $ or $ P_R $ on the \emph{right}.
