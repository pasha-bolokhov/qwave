...
\setcounter{equation}{0}
	...
	Recently, as series of works have been published which have developed a formalism for constructing
	...
	The wavefunction is named quaternionic just as an attempt of generalization of Quantum Mechanics,
	Quantum Electrodynamics, and so on.
	Even though such a theory may involve a new form of analysis, new operator formalisms,
	and other attractive features, it is not warranted by experiment in any sense. 
	The resulting Dirac or Schr\"odinger equations often include non-physical (unobserved) degrees of freedom.
