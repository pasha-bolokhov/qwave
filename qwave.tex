...
\label{by-parts}
	\uline\p{}_{\wt A}\,	\big(\, -\,\uuline\p\,\uline A ~+~ \wt{\uline A}\,\uuline\p \,\big)
				\big(\, \uuline{~~~~\dots~~~~} \,)
	~~+~~
	\uline\p{}_{\wt A}\,	\big(\, \uuline{~~~~\dots~~~~} \,)
...
\end{equation}
	...
	except for the underlined $ A $ factors.
	Applying identities \eqref{dq-vector} and \eqref{daq-vector}, we get, explicitly
\begin{equation}
\label{varied}
	2\,\wt\p\, \big(\, \uuline{~~~\dots~~~} \,)  ~~+~~
	4\,\wt\p\, \big(\, \uuline{~~~\dots~~~} \,)  ~~+~~
	2\,\wt\p\, \big(\, \uuline{~~~\dots~~~} \,)\wt{~}  ~~+~~
	4\, \big(\, \uuline{~~~\dots~~~} \,)_0\,\wt\p\,.
\end{equation}
