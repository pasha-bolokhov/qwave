...
\end{equation}
	...
	First, perhaps the easiest, is to rewrite it in the form identical to that of the
	left-handed mass term.
	That is, the last bracket in Eq.~\eqref{L-dirac-expanded} is the ``zeroth'' quaternionic component
	of $ \jj\, \psi_R^\dag\, \psi_L $, and as such, is invariant to cyclic permutations 
	of this term.
