...
\end{align}
	where $ \wt\p $ is defined as that for regular quaternions
\begin{equation}
	\wt\p	~~=~~	\p_t  ~~-~~  \ii\,\p_x  ~~-~~  \jj\,\p_y  ~~-~~  \kk\,\p_z\,.
\end{equation}
...
\end{align}
	...
	or its conjugates in an efficient way.
	...
	Even then, Section~\ref{sec-ordinary-quat} explains how to deal with such expressions.
