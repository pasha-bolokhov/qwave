...
\notag
	...
	\\[3mm]
%
	& \underline\p{}_{\wt A}\, (\p\, \underline A ~-~ \wt{\underline A}\,\wt \p)\, (\p\, A ~-~ \wt A\,\wt \p)
	~~+~~
	\underline\p{}_{\wt A}\, (\p\, A ~-~ \wt A\,\wt \p)\, (\p\, \underline A ~-~ \wt{\underline A}\,\wt \p)\,.
\end{align}
	...
	To indicate that they are now acting on different targets, we will doubly underline them.
\begin{equation}
	\uline\p{}_{\wt A}\,	\big(\, -\,\uuline\p\,\uline A ~+~ \wt{\uline A}\,\uuline\p \,\big)
				\big(\, \uuline{\p\, A ~-~ \wt A\,\wt \p} \,\big)
	~~+~~
	\uline\p{}_{\wt A}\,	\big(\, \uuline{\p\, A ~-~ \wt A\,\wt \p} \,\big)
				\big(\, -\,\uuline\p\,\uline A ~+~ \wt{\uline A}\,\uuline\p \,\big)
\end{equation}
	For the sake of variation, however, these derivatives are now just constants.
	In fact, everything is constant in regards to varying with respect to $ A $, except for the underlined $ A $ factors.
	



	Although a fair exercise in differentiation, the derivative with respect to the conjugate will actually
	give the same contribution.
	The reason we can guess that is that these two terms only differ by their complex-imaginary part
\begin{equation}
	\text{Im}~\Phi^2	~~\propto~~	\vec E \circ \vec B\,,
\end{equation}
	which is a boundary term and does not affect the equations of motion.
