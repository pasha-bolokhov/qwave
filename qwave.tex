...
\end{align}
	...
	in this study.
	Furthermore, the Standard Model, the way to which this work is meant to direct, is chiral in its nature.
	It is, however, possible to unite the terms in Eq.~\eqref{L-massless}.
	Doing so will be useful for promoting the theory to the quantum stage and developing the Feynman rules.
...
\label{section-discrete}
	...
	These symmetries can be given for an entire Dirac fermion $ \psi_D $.
...
\end{equation}
	Right-multiplying by $ i\kk $ keeps the sign of the left-handed spinor,
